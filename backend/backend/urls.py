...
urlpatterns = patterns('',
	...
	url(r'^Employees/(\d{1,3})/$', 'Employees.views.individual_employee'), #To do - for viewing an individual employee by there id number
	url(r'^tester/$', 'Employees.views.tester'), #View all employees
